...
const Portfolio = () => {
    return (
        <section id='portfolio' className='min-h-screen px-10 md:px-40'>
            ...
            <div className='grid md:grid-cols-3 gap-6 md:mt-16 mt-8'>
                <ProjectCard title="abc" tools={['abc','xyz', 'asd']} />
                <ProjectCard title="abc" tools={['abc']} />
                <ProjectCard title="abc" tools={['abc', 'asd']} />
                <ProjectCard title="abc" tools={['abc','xyz', 'asd']} />
            </div>
        </section>
    );

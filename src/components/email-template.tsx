      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={tipSection}>
            <Text style={tipText}>
              💡 <strong>Quick Reply:</strong> Just hit reply to respond
              directly to {name}
            </Text>
          </Section>
        </Container>
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            I've received your message and appreciate you taking the time to
            contact me. I'll review your inquiry and get back to you within
            24-48 hours.
          </Text>
